...
def calculate_pose_error(R_gt, t_gt, R_est, t_est):
    assert R_gt.shape == R_est.shape == (3, 3), "Rotation matrices must be of shape (3, 3)"
    assert t_gt.shape == t_est.shape == (3,), "Translation vectors must be of shape (3,)"
